/* ==========================================================================
   ...
   Correção Definitiva de Carregamento de Veículos e Estabilidade de Seletores
   ========================================================================== */

// Base Completa Nativa Integrada (Sem dependência externa para renderização)
...
async function calculateMultiRoute() {
  if (!map) return;
  alert("Cálculo acionado com sucesso.");
}
